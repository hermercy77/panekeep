...
- Tab Fridge supports `zh-CN` and `en`. Every new feature, field, menu item, state, notice, error, tooltip, accessibility label, manifest message, and documentation-facing UI term must ship in both languages in the same change.
